      ...
      <table className={styles.detailsTable}>
        ...
        <tbody>
          <tr>
            ...
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">{status.confirmed ? convertTimestamp(status.block_time) : 'Pending'}</span>
            </td>
          </tr>
          <tr>
            <td className={`detailText ${styles.cellPadding}`}>Age</td>
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">{status.confirmed ? calculateTimestampAge(status.block_time, true) : 'Pending'}</span>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table className={styles.detailsTable}>
        ...
        <tbody>
          <tr>
            ...
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">{addCommas(fee)}</span> SATS - ${FeestoDollars}
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">{roundToNearestTenth(fee / (weightToNum / 4))}</span> SATS/VB
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">{roundToNearestTenth(fee / size)}</span> SATS/VB
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">Foundry USA</span>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table className={styles.detailsTable}>
        ...
        <tbody>
          <tr>
            ...
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">{addCommas(size)}</span> B
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">{addCommas(weightToNum / 4)}</span> VB
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className={`detailText ${styles.cellPadding}`}>
              <span className="textHighlight">{addCommas(weightToNum)}</span> WU
            </td>
          </tr>
        </tbody>
      </table>
